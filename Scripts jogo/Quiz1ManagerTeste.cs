...
public class Quiz1ManagerTeste : MonoBehaviour{
    
    public Image ImagemQuestaoAtual;
    public Sprite[] vetorImagens;
    ...
    public void proximaPergunta(){
        ...
        ImagemQuestaoAtual.sprite = vetorImagens[idPergunta];
    ...
    public void verificarResposta(int resposta){
        ...
        if(resposta == respostaImagens[idPergunta]){
            ...
            if(contadorQuestoes <= questoes)
                ...
                PlayerPrefs.SetInt("Pontuacao1", pontuacao1);
                PlayerPrefs.Save();
                mostrarPontuacao();
   ...
   public void respostaErrada(){
    ...
    public void mostrarPontuacao(){
        ...
        mediaPontuacao = (float)pontuacao1 / (questoes*0.3f);

        painelQuiz.SetActive(false);
        painelPontuacao.SetActive(true);

        pontuacaoTela.text = mediaPontuacao.ToString("F1");
        numeroQuestoes.text = "VOCÊ CONSEGUIU " + pontuacao1 + " PONTOS DE " + questoes*3;
